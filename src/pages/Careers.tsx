      ...
      <div className="container mx-auto px-4 py-20 mt-10">
        ...
        >
          <div 
            ...
            style={{
              backgroundImage: `linear-gradient(90deg, rgba(71,85,105,0.9) 0%, rgba(203,213,225,0.85) 100%), url('https://images.unsplash.com/photo-1496307653780-42ee777d4833?auto=format&fit=crop&w=1600&q=80')`,
